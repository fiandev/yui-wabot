...
export const welcomev1: Command = {
  name: "welcomev1",
  cmd: ["welcomev1"],
  category: "Canvas",
  ...
  usage: "Usage: .welcomev1 <username> | guildName=<value> | guildIcon=<value> | memberCount=<value> | avatar=<value> | background=<value> | quality=<value>\nExample: .welcomev1 John | guildName=Anime Club | guildIcon=https://i.ibb.co/G5mJZxs/rin.jpg | memberCount=150 | avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg | background=https://i.ibb.co/4YBNyvP/images-76.jpg | quality=80",
  ...
  async execute(sock, msg) {
    ...
    if (parts.length > 1) {
        for (let i = 1; i < parts.length; i++) {
            ...
            if (key && value) {
                ...
                if (["username","guildName","guildIcon","memberCount","avatar","background","quality"].includes(key.trim())) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/canvas/welcomev1?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'welcomev1':", error);
