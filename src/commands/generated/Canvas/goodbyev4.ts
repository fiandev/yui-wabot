...
export const goodbyev4: Command = {
  name: "goodbyev4",
  cmd: ["goodbyev4"],
  category: "Canvas",
  ...
  usage: "Usage: .goodbyev4 <avatar> | background=<value> | description=<value>\nExample: .goodbyev4 https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg | background=https://i.ibb.co/4YBNyvP/images-76.jpg | description=Goodbye friend!",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/canvas/goodbyev4?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'goodbyev4':", error);
