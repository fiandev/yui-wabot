...
export const goodbyev2: Command = {
  name: "goodbyev2",
  cmd: ["goodbyev2"],
  category: "Canvas",
  ...
  usage: "Usage: .goodbyev2 <username> | guildName=<value> | memberCount=<value> | avatar=<value> | background=<value>\nExample: .goodbyev2 John | guildName=Siputzx Api | memberCount=150 | avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg | background=https://i.ibb.co/4YBNyvP/images-76.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/canvas/goodbyev2?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'goodbyev2':", error);
