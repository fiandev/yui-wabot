...
export const goodbyev5: Command = {
  name: "goodbyev5",
  cmd: ["goodbyev5"],
  category: "Canvas",
  ...
  usage: "Usage: .goodbyev5 <username> | guildName=<value> | memberCount=<value> | avatar=<value> | background=<value> | quality=<value>\nExample: .goodbyev5 Zero Two | guildName=Siputzx Community | memberCount=219 | avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg | background=https://i.ibb.co/4YBNyvP/mountain-sunset.jpg | quality=90",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/canvas/goodbyev5?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'goodbyev5':", error);
