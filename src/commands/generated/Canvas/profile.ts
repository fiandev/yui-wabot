...
export const profile: Command = {
  ...
  usage: "Usage: .profile <backgroundURL> | avatarURL=<value> | rankName=<value> | rankId=<value> | exp=<value> | requireExp=<value> | level=<value> | name=<value>\nExample: .profile https://i.ibb.co.com/2jMjYXK/IMG-20250103-WA0469.jpg | avatarURL=https://avatars.githubusercontent.com/u/159487561?v=4 | rankName=epik | rankId=0 | exp=500 | requireExp=1000 | level=10 | name=siputzx",
  ...
  async execute(sock, msg) {
    ...
    apiParams['backgroundURL'] = mainQuery;
    ...
    if (parts.length > 1) {
        for (let i = 1; i < parts.length; i++) {
            ...
            if (key && value) {
                ...
                if (["backgroundURL","avatarURL","rankName","rankId","exp","requireExp","level","name"].includes(key.trim())) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/canvas/profile?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'profile':", error);
