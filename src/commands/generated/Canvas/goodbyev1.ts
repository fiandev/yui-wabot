...
export const goodbyev1: Command = {
  name: "goodbyev1",
  cmd: ["goodbyev1"],
  category: "Canvas",
  ...
  usage: "Usage: .goodbyev1 <username> | guildName=<value> | guildIcon=<value> | memberCount=<value> | avatar=<value> | background=<value> | quality=<value>\nExample: .goodbyev1 John | guildName=Anime Club | guildIcon=https://i.ibb.co/G5mJZxs/rin.jpg | memberCount=150 | avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg | background=https://i.ibb.co/4YBNyvP/images-76.jpg | quality=80",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/canvas/goodbyev1?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'goodbyev1':", error);
