...
export const welcomev3: Command = {
  name: "welcomev3",
  cmd: ["welcomev3"],
  category: "Canvas",
  ...
  usage: "Usage: .welcomev3 <username> | avatar=<value>\nExample: .welcomev3 John | avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/canvas/welcomev3?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'welcomev3':", error);
