...
export const kbbi: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/kbbi?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'kbbi':", error);
