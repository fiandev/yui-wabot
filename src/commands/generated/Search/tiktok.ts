...
export const tiktok: Command = {
  ...
  cmd: ["tiktok"],
  category: "Search",
  description: "allows you to search for TikTok videos by providing a keyword. It returns a list of videos matching the search query, including details such as video URL, author, description, and other relevant metadata. This is useful for applications that want to integrate TikTok video search capabilities..",
  usage: "Usage: .tiktok <query>\nExample: .tiktok sad",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/tiktok?${searchParams.toString()}`;
