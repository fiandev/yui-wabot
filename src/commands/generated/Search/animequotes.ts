...
export const animequotes: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/s/animequotes?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'animequotes':", error);
