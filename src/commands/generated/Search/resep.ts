...
export const resep: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/resep?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'resep':", error);
