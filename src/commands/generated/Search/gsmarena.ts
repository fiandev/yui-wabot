...
export const gsmarena: Command = {
  name: "gsmarena",
  cmd: ["gsmarena"],
  category: "Search",
  description: "allows users to search for mobile phone information on GSMArena.com. By providing a search query, users can retrieve a list of devices matching the query, including their ID, name, thumbnail image, and a brief description. This is useful for developers building applications that require device specifications or for users who want to quickly look up phone models and their basic details..",
  usage: "Usage: .gsmarena <query>\nExample: .gsmarena iphone",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/s/gsmarena?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'gsmarena':", error);
