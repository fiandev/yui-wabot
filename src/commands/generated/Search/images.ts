...
export const images: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/images?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'images':", error);
