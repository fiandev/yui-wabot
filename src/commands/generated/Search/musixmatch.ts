...
export const musixmatch: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/s/musixmatch?${searchParams.toString()}`;
