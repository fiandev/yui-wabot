...
export const bimg: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/bimg?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'bimg':", error);
