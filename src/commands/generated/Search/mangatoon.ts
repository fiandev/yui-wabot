...
export const mangatoon: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/s/mangatoon?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'mangatoon':", error);
