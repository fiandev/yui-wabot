...
export const wikipedia: Command = {
  ...
  cmd: ["wikipedia"],
  category: "Search",
  description: "allows you to search for articles on Wikipedia (Indonesian version) by providing a search query. It returns the main descriptive paragraph of the article and an associated thumbnail image if available. This is useful for quickly retrieving summaries of topics from Wikipedia..",
  usage: "Usage: .wikipedia <query>\nExample: .wikipedia prabowo",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/wikipedia?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'wikipedia':", error);
