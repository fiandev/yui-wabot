...
export const mcpedl: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/s/mcpedl?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'mcpedl':", error);
