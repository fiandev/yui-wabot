...
export const qr2text: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/qr2text?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'qr2text':", error);
