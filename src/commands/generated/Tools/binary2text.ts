...
export const binary2text: Command = {
  name: "binary2text",
  cmd: ["binary2text"],
  category: "Tools",
  description: "converts a binary code string into human-readable text. Users can provide a space-separated binary string as a query parameter, and the API will decode it to its corresponding text representation. This utility is useful for decoding binary messages or data back into a readable format..",
  usage: "Usage: .binary2text <content>\nExample: .binary2text 01001000 01100101 01101100 01101100 01101111",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/binary2text?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'binary2text':", error);
