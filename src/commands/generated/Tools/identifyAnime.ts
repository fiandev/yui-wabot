...
export const identifyAnime: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/tools/identify-anime?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'identifyAnime':", error);
