...
export const kodepos: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/kodepos?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'kodepos':", error);
