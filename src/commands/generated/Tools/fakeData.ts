...
export const fakeData: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/fake-data?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'fakeData':", error);
