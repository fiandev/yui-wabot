...
export const text2base64: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/tools/text2base64?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'text2base64':", error);
