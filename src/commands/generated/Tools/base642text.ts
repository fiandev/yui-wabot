...
export const base642text: Command = {
  name: "base642text",
  cmd: ["base642text"],
  category: "Tools",
  ...
  usage: "Usage: .base642text <base64>\nExample: .base642text SGVsbG8gV29ybGQ=",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/base642text?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'base642text':", error);
