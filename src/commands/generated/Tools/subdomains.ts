...
export const subdomains: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/subdomains?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'subdomains':", error);
