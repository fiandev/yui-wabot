...
export const text2binary: Command = {
  name: "text2binary",
  cmd: ["text2binary"],
  category: "Tools",
  ...
  usage: "Usage: .text2binary <content>\nExample: .text2binary Hello",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/tools/text2binary?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'text2binary':", error);
