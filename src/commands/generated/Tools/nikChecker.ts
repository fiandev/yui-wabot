...
export const nikChecker: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/tools/nik-checker?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'nikChecker':", error);
