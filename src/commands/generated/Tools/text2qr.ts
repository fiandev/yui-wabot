...
export const text2qr: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/tools/text2qr?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'text2qr':", error);
