...
export const dewatermark: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/tools/dewatermark?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'dewatermark':", error);
