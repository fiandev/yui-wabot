...
export const ytpost: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/ytpost?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'ytpost':", error);
