...
export const happymod: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/apk/happymod?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'happymod':", error);
