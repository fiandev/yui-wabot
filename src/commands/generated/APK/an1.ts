...
export const an1: Command = {
  name: "an1",
  cmd: ["an1"],
  category: "APK",
  description: "allows you to search for Android applications on an1.com. It scrapes the website based on your provided search query and returns a list of relevant applications, including their title, download link, developer, image, rating, and whether it's a MOD or Original version. This can be used by developers needing to programmatically find and list applications available on an1.com..",
  usage: "Usage: .an1 <search>\nExample: .an1 pou",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/apk/an1?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'an1':", error);
