...
export const openapk: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/apk/openapk?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'openapk':", error);
