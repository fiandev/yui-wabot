...
export const appstore: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/apk/appstore?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'appstore':", error);
