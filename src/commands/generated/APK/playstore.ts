...
export const playstore: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/apk/playstore?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'playstore':", error);
