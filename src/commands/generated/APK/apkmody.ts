...
export const apkmody: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/apk/apkmody?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'apkmody':", error);
