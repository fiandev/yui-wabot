...
export const powerbrainai: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/powerbrainai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'powerbrainai':", error);
