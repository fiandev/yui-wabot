...
export const youai: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/youai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'youai':", error);
