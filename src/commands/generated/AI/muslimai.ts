...
export const muslimai: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/muslimai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'muslimai':", error);
