...
export const metaai: Command = {
  ...
  usage: "Usage: .metaai <query>\nExample: .metaai Tell me a fun fact about space.",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/metaai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'metaai':", error);
