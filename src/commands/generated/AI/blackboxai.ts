...
export const blackboxai: Command = {
  name: "blackboxai",
  cmd: ["blackboxai"],
  category: "AI",
  ...
  usage: "Usage: .blackboxai <content>\nExample: .blackboxai Hello, how are you today?",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/blackboxai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'blackboxai':", error);
