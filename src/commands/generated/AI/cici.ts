...
export const cici: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/cici?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'cici':", error);
