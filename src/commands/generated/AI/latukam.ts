...
export const latukam: Command = {
  ...
  usage: "Usage: .latukam <content>\nExample: .latukam Hello AI, how are you?",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/latukam?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'latukam':", error);
