...
export const felo: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/felo?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'felo':", error);
