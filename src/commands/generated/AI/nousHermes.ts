...
export const nousHermes: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/nous-hermes?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'nousHermes':", error);
