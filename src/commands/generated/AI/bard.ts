...
export const bard: Command = {
  ...
  usage: "Usage: .bard <query>\nExample: .bard Tell me about the history of artificial intelligence.",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/bard?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'bard':", error);
