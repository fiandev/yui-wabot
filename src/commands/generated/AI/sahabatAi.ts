...
export const sahabatAi: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/sahabat-ai?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'sahabatAi':", error);
