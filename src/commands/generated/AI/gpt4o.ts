...
export const gpt4o: Command = {
  ...
  usage: "Usage: .gpt4o <prompt> | content=<value>\nExample: .gpt4o You are a helpful assistant. | content=Tell me a joke.",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/gpt-4o?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'gpt4o':", error);
