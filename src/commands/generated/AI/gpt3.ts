...
export const gpt3: Command = {
  ...
  usage: "Usage: .gpt3 <prompt> | content=<value>\nExample: .gpt3 You are a helpful assistant. | content=Tell me a joke.",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/gpt3?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'gpt3':", error);
