...
export const gita: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/gita?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'gita':", error);
