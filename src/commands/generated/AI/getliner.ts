...
export const getliner: Command = {
  name: "getliner",
  cmd: ["getliner"],
  category: "AI",
  description: "provides access to getliner AI, allowing users to get AI-generated responses by submitting text queries via URL parameters. It supports various getliner models for diverse AI capabilities, from general queries to more complex reasoning tasks. The 'text' parameter is mandatory for the user's input. The API will return the AI's response..",
  usage: "Usage: .getliner <text>\nExample: .getliner What is quantum physics?",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/getliner?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'getliner':", error);
