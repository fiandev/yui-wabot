...
export const deepseekLlm67bChat: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/deepseek-llm-67b-chat?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'deepseekLlm67bChat':", error);
