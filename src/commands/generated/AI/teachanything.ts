...
export const teachanything: Command = {
  name: "teachanything",
  cmd: ["teachanything"],
  category: "AI",
  description: "provides access to the 'Teach Anything' AI service, enabling users to get explanations or information on various topics by providing text content via query parameters. It's designed for educational applications, quick knowledge retrieval, or any platform that needs to explain complex subjects in a simple manner. The 'content' parameter is mandatory and should contain the topic or question you want the AI to explain. The API will return the AI's generated explanation..",
  usage: "Usage: .teachanything <content>\nExample: .teachanything Explain how photosynthesis works.",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/ai/teachanything?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'teachanything':", error);
