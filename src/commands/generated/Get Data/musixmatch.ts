...
export const musixmatch: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/get/musixmatch?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'musixmatch':", error);
