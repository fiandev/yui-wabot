...
export const ampreset: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/get/ampreset?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'ampreset':", error);
