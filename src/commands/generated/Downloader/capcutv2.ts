...
export const capcutv2: Command = {
  name: "capcutv2",
  cmd: ["capcutv2"],
  category: "Downloader",
  description: "Alternative CapCut video downloader using third-party service. allows you to download CapCut videos with different quality options including HD No Watermark, No Watermark, and Watermark versions. It provides direct download URLs, file sizes, and format information..",
  usage: "Usage: .capcutv2 <url>\nExample: .capcutv2 https://www.capcut.com/tv2/ZSSCR6UFU/",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/capcutv2?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'capcutv2':", error);
