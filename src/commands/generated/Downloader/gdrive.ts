...
export const gdrive: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/gdrive?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'gdrive':", error);
