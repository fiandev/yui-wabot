...
export const musicapple: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/musicapple?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'musicapple':", error);
