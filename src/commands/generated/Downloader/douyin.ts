...
export const douyin: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/douyin?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'douyin':", error);
