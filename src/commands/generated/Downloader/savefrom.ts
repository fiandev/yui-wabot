...
export const savefrom: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/savefrom?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'savefrom':", error);
