...
export const capcut: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/capcut?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'capcut':", error);
