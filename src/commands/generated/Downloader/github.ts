...
export const github: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/github?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'github':", error);
