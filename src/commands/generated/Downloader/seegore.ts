...
export const seegore: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/seegore?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'seegore':", error);
