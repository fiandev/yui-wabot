...
export const spotifyv2: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/spotifyv2?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'spotifyv2':", error);
