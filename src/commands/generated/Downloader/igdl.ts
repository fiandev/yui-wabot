...
export const igdl: Command = {
  name: "igdl",
  cmd: ["igdl"],
  category: "Downloader",
  description: "allows users to download Instagram videos and photos by providing the Instagram post URL. It automates the process of accessing a third-party downloader website (fastdl.app), inputting the URL, and scraping the resulting download links. The endpoint handles various types of Instagram content, including reels, photos, and videos, and returns the direct download URLs and thumbnails. This is useful for users who want to save Instagram media for offline viewing or integration into other applications..",
  usage: "Usage: .igdl <url>\nExample: .igdl https://www.instagram.com/reel/DMNiqN2TV3v/?igsh=aHVtdmZ3d3loejY0",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/igdl?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'igdl':", error);
