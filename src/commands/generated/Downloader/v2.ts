...
export const v2: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/tiktok/v2?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'v2':", error);
