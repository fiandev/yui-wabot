...
export const pinterest: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/pinterest?${searchParams.toString()}`;
