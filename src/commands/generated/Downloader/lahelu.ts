...
export const lahelu: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/lahelu?${searchParams.toString()}`;
