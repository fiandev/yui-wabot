...
export const mediafire: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/mediafire?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'mediafire':", error);
