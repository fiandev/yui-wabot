...
export const rednote: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/d/rednote?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'rednote':", error);
