...
export const facebook: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/d/facebook?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'facebook':", error);
