...
export const stickerlyDetail: Command = {
  name: "stickerlyDetail",
  cmd: ["stickerlyDetail"],
  category: "Sticker",
  ...
  usage: "Usage: .stickerlyDetail <url>\nExample: .stickerlyDetail https://sticker.ly/s/W7ES6T",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/sticker/stickerly-detail?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'stickerlyDetail':", error);
