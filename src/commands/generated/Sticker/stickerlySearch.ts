...
export const stickerlySearch: Command = {
  ...
  usage: "Usage: .stickerlySearch <query>\nExample: .stickerlySearch love",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/sticker/stickerly-search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'stickerlySearch':", error);
