...
export const combotSearch: Command = {
  name: "combotSearch",
  cmd: ["combotSearch"],
  category: "Sticker",
  ...
  usage: "Usage: .combotSearch <q> | page=<value>\nExample: .combotSearch jomok nye | page=1",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/sticker/combot-search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'combotSearch':", error);
