...
export const search: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/samehadaku/search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'search':", error);
