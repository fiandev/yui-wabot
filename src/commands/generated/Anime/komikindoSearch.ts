...
export const komikindoSearch: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/anime/komikindo-search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'komikindoSearch':", error);
