...
export const detail: Command = {
  ...
  usage: "Usage: .detail <link>\nExample: .detail https://samehadaku.email/anime/blue-lock-season-2/",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/anime/samehadaku/detail?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'detail':", error);
