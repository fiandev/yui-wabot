...
export const oploverzSearch: Command = {
  name: "oploverzSearch",
  cmd: ["oploverzSearch"],
  category: "Anime",
  description: "allows users to search for anime series on Oploverz. It takes a search query and returns a list of matching anime titles, their respective links, cover images, number of episodes, and ratings. This is useful for applications that need to implement search functionality for Oploverz's anime catalog, enabling users to quickly find specific series..",
  usage: "Usage: .oploverzSearch <query>\nExample: .oploverzSearch romance",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/oploverz-search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'oploverzSearch':", error);
