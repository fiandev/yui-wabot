...
export const auratailDetail: Command = {
  name: "auratailDetail",
  cmd: ["auratailDetail"],
  category: "Anime",
  ...
  usage: "Usage: .auratailDetail <url>\nExample: .auratailDetail https://auratail.vip/the-war-of-cards/",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/auratail-detail?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'auratailDetail':", error);
