...
export const anichinEpisode: Command = {
  name: "anichinEpisode",
  cmd: ["anichinEpisode"],
  category: "Anime",
  description: "allows you to retrieve a list of episodes for a specific anime from Anichin by providing the anime's URL. It scrapes details such as episode number, title, sub status (e.g., 'SUB INDO'), release date, and the link to the episode page. This is useful for applications that need to display episode lists and provide direct links to episode content..",
  usage: "Usage: .anichinEpisode <url>\nExample: .anichinEpisode https://anichin.forum/renegade-immortal/",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/anichin-episode?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'anichinEpisode':", error);
