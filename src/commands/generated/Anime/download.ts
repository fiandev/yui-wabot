...
export const download: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/anime/samehadaku/download?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'download':", error);
