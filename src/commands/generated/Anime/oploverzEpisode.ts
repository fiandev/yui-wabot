...
export const oploverzEpisode: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/oploverz-episode?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'oploverzEpisode':", error);
