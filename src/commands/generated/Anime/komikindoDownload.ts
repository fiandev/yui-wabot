...
export const komikindoDownload: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/komikindo-download?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'komikindoDownload':", error);
