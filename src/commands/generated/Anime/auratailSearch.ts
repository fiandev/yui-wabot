...
export const auratailSearch: Command = {
  name: "auratailSearch",
  cmd: ["auratailSearch"],
  category: "Anime",
  description: "allows you to search for anime on Auratail by providing a search query. It scrapes the search results and returns a list of anime titles, links to their detail pages, images, and their current status. This is useful for applications that need to find anime titles from Auratail..",
  usage: "Usage: .auratailSearch <query>\nExample: .auratailSearch war",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/anime/auratail-search?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'auratailSearch':", error);
