...
export const compress: Command = {
  ...
  cmd: ["compress"],
  category: "Iloveimg",
  description: "Compress an image by providing its URL. allows you to reduce the file size of an image fetched from a given URL. It supports common image formats like JPG, JPEG, PNG, GIF, and WEBP. The compressed image will be returned as a binary response. This is useful for optimizing website performance or reducing storage space..",
  usage: "Usage: .compress <image>\nExample: .compress https://i.pinimg.com/736x/0b/9f/0a/0b9f0a92a598e6c22629004c1027d23f.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/iloveimg/compress?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'compress':", error);
