...
export const image2jpg: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/iloveimg/image2jpg?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'image2jpg':", error);
