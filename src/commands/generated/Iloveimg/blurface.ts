...
export const blurface: Command = {
  ...
  usage: "Usage: .blurface <image>\nExample: .blurface https://i.pinimg.com/736x/0b/9f/0a/0b9f0a92a598e6c22629004c1027d23f.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/iloveimg/blurface?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'blurface':", error);
