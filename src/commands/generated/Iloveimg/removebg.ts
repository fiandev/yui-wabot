...
export const removebg: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/iloveimg/removebg?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'removebg':", error);
