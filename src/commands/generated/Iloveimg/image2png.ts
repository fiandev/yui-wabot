...
export const image2png: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/iloveimg/image2png?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'image2png':", error);
