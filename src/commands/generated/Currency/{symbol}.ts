...
export const _symbol_: Command = {
  ...
  usage: "Usage: ._symbol_ <symbol>\nExample: ._symbol_ BTC",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/currency/crypto/{symbol}?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command '_symbol_':", error);
