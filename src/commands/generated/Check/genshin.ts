...
export const genshin: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/check/genshin?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'genshin':", error);
