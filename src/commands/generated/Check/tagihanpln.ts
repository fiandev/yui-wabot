...
export const tagihanpln: Command = {
  name: "tagihanpln",
  cmd: ["tagihanpln"],
  category: "Check",
  ...
  usage: "Usage: .tagihanpln <nopel>\nExample: .tagihanpln 443100003506",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/check/tagihanpln?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'tagihanpln':", error);
