...
export const tiktok: Command = {
  ...
  cmd: ["tiktok"],
  category: "Stalker",
  description: "allows you to retrieve public profile information for a specified TikTok user using their username as a query parameter. It fetches detailed user information, including statistics and other publicly available data. This is useful for applications requiring TikTok user data for display, analysis, or integration..",
  usage: "Usage: .tiktok <username>\nExample: .tiktok mrbeast",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/stalk/tiktok?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'tiktok':", error);
