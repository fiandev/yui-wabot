...
export const instagram: Command = {
  ...
  cmd: ["instagram"],
  category: "Stalker",
  description: "allows you to retrieve detailed profile information for any Instagram user by providing their username as a query parameter. It fetches public data such as their full name, biography, profile picture URL, follower and following counts, post count, and details about their recent posts including captions, like counts, and comments. This is ideal for applications needing to display Instagram user profiles or analyze public Instagram data..",
  usage: "Usage: .instagram <username>\nExample: .instagram google",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/stalk/instagram?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'instagram':", error);
