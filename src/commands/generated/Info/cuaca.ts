...
export const cuaca: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/info/cuaca?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'cuaca':", error);
