...
export const jadwaltv: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/info/jadwaltv?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'jadwaltv':", error);
