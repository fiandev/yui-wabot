...
export const ramalanjodoh: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/primbon/ramalanjodoh?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'ramalanjodoh':", error);
