...
export const zodiak: Command = {
  ...
  usage: "Usage: .zodiak <zodiak>\nExample: .zodiak input utama",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/primbon/zodiak?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'zodiak':", error);
