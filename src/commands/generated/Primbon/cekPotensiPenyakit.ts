...
export const cekPotensiPenyakit: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/primbon/cek_potensi_penyakit?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'cekPotensiPenyakit':", error);
