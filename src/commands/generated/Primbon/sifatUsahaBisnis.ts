...
export const sifatUsahaBisnis: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/primbon/sifat_usaha_bisnis?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'sifatUsahaBisnis':", error);
