...
export const alay: Command = {
  ...
  usage: "Usage: .alay <text>\nExample: .alay HelloWorld",
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/fun/alay?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'alay':", error);
