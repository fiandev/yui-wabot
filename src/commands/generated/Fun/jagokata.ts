...
export const jagokata: Command = {
  name: "jagokata",
  cmd: ["jagokata"],
  category: "Fun",
  description: "allows you to search for quotes on jagokata.com, a popular Indonesian website for quotes and sayings. By providing a search query, you can retrieve a list of relevant quotes, along with details such as the author, description, lifespan, number of votes, category, and associated tags. This API is useful for applications that require a collection of wisdom, inspiration, or famous sayings..",
  usage: "Usage: .jagokata <q>\nExample: .jagokata kesuksesan",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/fun/jagokata?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'jagokata':", error);
