...
export const embedding: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const url = `${BASE_URL}/api/cf/embedding?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'embedding':", error);
