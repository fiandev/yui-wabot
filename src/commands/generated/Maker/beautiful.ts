...
export const beautiful: Command = {
  ...
  cmd: ["beautiful"],
  category: "Maker",
  description: "applies a 'beautiful' effect to an image provided via a URL. It fetches the image, overlays it onto a base image, and returns the modified image. This effect can be used to add an artistic or decorative touch to user-submitted images, making them appear more visually appealing for various creative applications..",
  usage: "Usage: .beautiful <image>\nExample: .beautiful https://i.ibb.co/9rtTrVy/download-1.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/m/beautiful?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'beautiful':", error);
