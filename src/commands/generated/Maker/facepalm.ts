...
export const facepalm: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/m/facepalm?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'facepalm':", error);
