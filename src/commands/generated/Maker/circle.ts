...
export const circle: Command = {
  ...
  usage: "Usage: .circle <image>\nExample: .circle https://i.ibb.co/9rtTrVy/download-1.jpg",
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/m/circle?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'circle':", error);
