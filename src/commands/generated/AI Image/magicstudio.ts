...
export const magicstudio: Command = {
  ...
  async execute(sock, msg) {
    ...
    try {      
      ...
      const url = `${BASE_URL}/api/ai/magicstudio?${searchParams.toString()}`;
      ...
      console.error("Error saat menjalankan command 'magicstudio':", error);
